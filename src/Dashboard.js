...
const Dashboard = () => {
  return <div className="App">
    ...
    <div className="charts">
      <Chart height={'400px'} width={'400px'} chartId={'630f67ac-abe7-4912-8db3-db35526cbdbd'} maxDataAge={10}/>
      <Chart height={'400px'} width={'400px'} chartId={'630f695c-f920-41db-80e3-da5cb6cf5bab'} maxDataAge={10}/>
    </div>
    <div className="charts">
